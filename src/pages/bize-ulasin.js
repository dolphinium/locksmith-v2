...
const XIcon = () => <svg viewBox="0 0 24 24" width="24" height="24" fill="#000000"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>;
...
const YouTubeIcon = () => <svg viewBox="0 0 24 24" width="24" height="24" fill="#FF0000"><path d="M23.498 6.186a3.016 3.016 0 00-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 00.502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 002.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 002.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg>;
...
const BizeUlasinPage = () => {
  ...
  return (
    <Layout title="Bize Ulaşın - Rem Anahtar">
      <div className={styles.bizeUlasinPage}>
        <div className={styles.pageHeader}>
          <p className={styles.subTitle}>Bize Ulaşın</p>
          <h1 className={styles.mainTitle}>Rem Anahtar - Lokasyon</h1>
        </div>
        ...
        <div className={styles.contactDetailsSection}>
          <div className={styles.infoAndImage}>
            ...
            <div className={styles.infoText}>
              ...
              <p><strong>E-Posta:</strong> <a href="mailto:info@remanahtar.com">info@remanahtar.com</a></p>
          ...
          <div className={styles.socialMedia}>
            ...
            <div className={styles.socialIcons}>
              <a href="https://www.facebook.com/remanahtar" target="_blank" rel="noopener noreferrer"><FacebookIcon /> Facebook</a>
              <a href="https://twitter.com/remanahtar" target="_blank" rel="noopener noreferrer"><XIcon /> X</a>
              <a href="https://www.instagram.com/remanahtar" target="_blank" rel="noopener noreferrer"><InstagramIcon /> Instagram</a>
              <a href="https://www.youtube.com/remanahtar" target="_blank" rel="noopener noreferrer"><YouTubeIcon /> Youtube</a>
            </div>
          </div>
        </div>
